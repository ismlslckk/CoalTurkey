  ...
  var M = function(g) {
        ...
        b = g("<div/>")
          ...
          .append(
            g("<div/>")
              ...
              .append(g('<div class="test"/>').css({ width: "100%", height: 10 }))
          )
          .appendTo("body"),
        c = b.find(".test");
    ...
    function fa(a, b, c) {
      ...
      c !== l &&
        ...
        c.sType && (d._sManualType = c.sType),
        c.className && !c.sClass && (c.sClass = c.className),
        g.extend(d, c),
        D(d, c, "sWidth", "sWidthOrig"),
        "number" === typeof c.iDataSort && (d.aDataSort = [c.iDataSort]),
        D(d, c, "aDataSort"));
      var c = d.mData,
        h = T(c),
      ...
      for (f = b.length; e < f; e++)
        if (((m = b[e]), (k = []), !m.sType && m._sManualType)) m.sType = m._sManualType;
          ...
          for (i = d.length; h < i; h++) {
            ...
            for (
              g = c.length;
              j < g && !(k[j] === l && (k[j] = A(a, j, e, "type")), (o = d[h](k[j], a)), !o || "html" === o);
              j++
            );
            if (o) {
              m.sType = o;
    ...
    function H(a, b, c, d) {
      var e = a.aoData.length,
        f = g.extend(!0, {}, p.models.oRow, { src: c ? "dom" : "data" });
      f._aData = b;
      a.aoData.push(f);
          ...
          a.iDrawError != a.iDraw &&
            ...
            (O(
              ...
              "Requested unknown parameter " +
                ("function" == typeof c.mData ? "{function}" : "'" + c.mData + "'") +
                " for row " +
                b,
              4
            ),
    ...
    function ia(a, b) {
      var c = [],
        ...
        o = function(a, b, c) {
          "string" === typeof a &&
            ((b = a.indexOf("@")), -1 !== b && ((a = a.substring(b + 1)), (i["@" + a] = c.getAttribute(a))));
        },
        k = function(a) {
          h = m[j];
          n = g.trim(a.innerHTML);
          h && h._bAttrSrc
            ? ((i = { display: n }), o(h.mData.sort, i, a), o(h.mData.type, i, a), o(h.mData.filter, i, a), c.push(i))
            : c.push(n);
          d.push(a);
          j++;
        };
      if (e) for (; e; ) (f = e.nodeName.toUpperCase()), ("TD" == f || "TH" == f) && k(e), (e = e.nextSibling);
      else {
        d = b.anCells;
        e = 0;
      ...
      for (c = m.length; b < c; b++)
        (f = m[b]),
          ...
          a.oFeatures.bSort &&
            ...
            !1 !== f.bSortable && (d.attr("tabindex", a.iTabIndex).attr("aria-controls", a.sTableId), Ka(a, f.nTh, b))),
        ...
        for (e = h.length; d < e; d++) {
          ...
          for (b = h[d].length; f < b; f++)
            if (((n = j = 1), i[d][f] === l)) {
              ...
              for (i[d][f] = 1; h[d + j] !== l && h[d][f].cell == h[d + j][f].cell; ) (i[d + j][f] = 1), j++;
    ...
    function J(a) {
      ...
      if (-1 !== g.inArray(!1, b)) C(a, !1);
        ...
        h !== l &&
          -1 !== h &&
          ((a._iDisplayStart = i ? h : h >= a.fnRecordsDisplay() ? 0 : h), (a.iInitDisplayStart = -1));
        ...
        if (0 !== j.length) {
          ...
          (c = f.sZeroRecords),
            ...
            (b[0] = g("<tr/>", { class: e ? d[0] : "" }).append(
              g("<td />", { valign: "top", colSpan: Y(a), class: a.oClasses.sRowEmpty }).html(c)
            )[0]);
    ...
    function kb(a) {
      var b = a.oClasses,
        ...
        d = a.oFeatures,
        e = g("<div/>", { id: a.sTableId + "_wrapper", class: b.sWrapper + (a.nTFoot ? "" : " " + b.sNoFooter) });
      a.nHolding = c[0];
      a.nTableWrapper = e[0];
      ...
      for (var f = a.sDom.split(""), h, i, j, n, m, o, k = 0; k < f.length; k++) {
        ...
        if ("<" == i) {
          ...
          if ("'" == n || '"' == n) {
            ...
            -1 != m.indexOf(".")
              ? ((n = m.split(".")), (j.id = n[0].substr(1, n[0].length - 1)), (j.className = n[1]))
              : "#" == m.charAt(0)
      ...
      for (j = c.length; f < j; f++) {
        ...
        for (e = d.firstChild; e; ) {
          if ("TD" == e.nodeName.toUpperCase() || "TH" == e.nodeName.toUpperCase()) {
            ...
            k = 1 === m ? !0 : !1;
            for (i = 0; i < m; i++)
              for (h = 0; h < o; h++) (a[f + h][n + i] = { cell: e, unique: k }), (a[f + h].nTr = d);
          }
          e = e.nextSibling;
        }
      }
    ...
    function na(a, b, c) {
      ...
      a.fnServerData
        ...
        ? (a.jqXHR = g.ajax(g.extend(j, { url: h || a.sAjaxSource })))
        : g.isFunction(h)
    ...
    function mb(a) {
      var b = a.oClasses,
        ...
        e = function() {
          ...
          b != d.sSearch &&
            (aa(a, { sSearch: b, bRegex: d.bRegex, bSmart: d.bSmart, bCaseInsensitive: d.bCaseInsensitive }),
            (a._iDisplayStart = 0),
            J(a));
        },
        i = g("input", b)
          .val(d.sSearch.replace('"', "&quot;"))
          .bind("keyup.DT search.DT input.DT paste.DT cut.DT", "ssp" === z(a) ? Ma(e, 400) : e)
      ...
      for (f = a.aoData.length; d < f; d++)
        if (((g = a.aoData[d]), !g._aFilterData)) {
          ...
          for (h = b.length; e < h; e++)
            (c = b[e]),
              c.bSearchable
                ? ((j = A(a, d, e, "filter")), (j = m[c.sType] ? m[c.sType](j) : null !== j ? j : ""))
                : (j = ""),
    ...
    function lb(a) {
      for (
        var b = a.oClasses,
          ...
          f = e ? d[0] : d,
          e = e ? d[1] : d,
          d = g("<select/>", { name: c + "_length", "aria-controls": c, class: b.sLengthSelect }),
          h = 0,
          i = f.length;
        h < i;
        h++
    ...
    function nb(a) {
      return g("<div/>", { id: !a.aanFeatures.r ? a.sTableId + "_processing" : null, class: a.oClasses.sProcessing })
    ...
    function ob(a) {
      ...
      m.length || (m = null);
      c = g("<div/>", { class: f.sScrollWrapper })
        .append(
          g("<div/>", { class: f.sScrollHead })
            .css({ overflow: "hidden", position: "relative", border: 0, width: d ? (!d ? null : s(d)) : "100%" })
            .append(
        ...
        .append(
          g("<div/>", { class: f.sScrollBody })
            .css({ overflow: "auto", height: !e ? null : s(e), width: !d ? null : s(d) })
            .append(b)
        );
      m &&
        c.append(
          g("<div/>", { class: f.sScrollFoot })
            .css({ overflow: "hidden", border: 0, width: d ? (!d ? null : s(d)) : "100%" })
            .append(
    ...
    function V(a) {
      ...
      if ("" === c) {
        ...
        "" !== d
          ? (L.width = s(d))
          : h == o.width() && o.height() < q.height()
          ? ((L.width = s(h - f)), q.outerWidth() > h - f && (L.width = s(h)))
          : (L.width = s(h));
      h = q.outerWidth();
      F(E, y);
      F(function(a) {
      ...
      e &&
        b.bCollapse &&
        ((k.height = s(e)),
        (b = c && ba.offsetWidth > j.offsetWidth ? f : 0),
        ba.offsetHeight < j.offsetHeight && (k.height = s(ba.offsetHeight + b)));
      b = q.outerWidth();
      m[0].style.width = s(b);
      n.width = s(b);
    ...
    function Ca(a) {
      ...
      if (!o && !f && !e && i == Y(a) && i == j.length) for (k = 0; k < i; k++) c[k].sWidth = s(j.eq(k).width());
        ...
        if (a.aoData.length)
          for (k = 0; k < d.length; k++)
            (o = d[k]),
              ...
              g(Ab(a, o))
                .clone(!1)
                .append(l.sContentPadding)
                .appendTo(p);
        i.appendTo(m);
        f && h
          ? i.width(h)
          : f
          ? (i.css("width", "auto"), i.width() < m.offsetWidth && i.width(m.offsetWidth))
          : e
        ...
        for (k = 0; k < d.length; k++) if (((l = c[d[k]]), (e = g(j[k]).width()))) l.sWidth = s(e);
    ...
    function Db() {
      if (!p.__scrollbarWidth) {
        var a = g("<p/>").css({ width: "100%", height: 200, padding: 0 })[0],
          b = g("<div/>")
            .css({
              position: "absolute",
              top: 0,
    ...
    function Q(a) {
      ...
      for (a = 0; a < n.length; a++) {
        ...
        for (c = f.length; b < c; b++)
          (h = f[b]),
            (i = e[h].sType || "string"),
            d.push({ src: j, col: h, dir: n[a][1], index: n[a][2], type: i, formatter: p.ext.type.order[i + "-pre"] });
      }
      return d;
    }
    function jb(a) {
      ...
      for (var b, c, d = a.aoColumns, e = Q(a), a = a.oLanguage.oAria, f = 0, h = d.length; f < h; f++) {
        ...
        c.bSortable &&
          (0 < e.length && e[0].col == f
            ? (g.setAttribute("aria-sort", "asc" == e[0].dir ? "ascending" : "descending"),
              (c = i[e[0].index + 1] || i[0]))
            : (c = i[0]),
    ...
    function Gb(a) {
      ...
      if (a.oFeatures.bStateSave) {
        ...
        if (
          e &&
          ((b = t(a, "aoStateLoadParams", "stateLoadParams", [a, e])),
          -1 === g.inArray(!1, b) &&
            ((b = a.iStateDuration),
            !(0 < b && e.iCreate < +new Date() - 1e3 * b) && d.length === e.aoSearchCols.length))
        ) {
    ...
    function Hb(a, b, c) {
      ...
      for (e in b)
        b.hasOwnProperty(e) &&
          ((d = b[e]),
          g.isPlainObject(d)
            ? (g.isPlainObject(a[e]) || (a[e] = {}), g.extend(!0, a[e], d))
            : (a[e] = c && "data" !== e && "aaData" !== e && g.isArray(d) ? d.slice() : d));
      return a;
    }
    function Ta(a, b, c) {
      g(a)
    ...
    function Ua(a, b) {
      ...
      b <= c
        ...
        : (a >= b - 1 - d ? (c = R(b - (c - 2), b)) : ((c = R(a - 1, a + 2)), c.push("ellipsis"), c.push(b - 1)),
    ...
    p = function(a) {
      ...
      this.each(function() {
        ...
        if ("table" != this.nodeName.toLowerCase())
          ...
          h.aLengthMenu &&
            !h.iDisplayLength &&
            (h.iDisplayLength = g.isArray(h.aLengthMenu[0]) ? h.aLengthMenu[0][0] : h.aLengthMenu[0]);
          h = Hb(g.extend(!0, {}, m), h);
          D(
            k.oFeatures,
            h,
          ...
          n = k.oClasses;
          h.bJQueryUI
            ? (g.extend(n, p.ext.oJUIClasses, h.oClasses),
              h.sDom === m.sDom && "lfrtip" === m.sDom && (k.sDom = '<"H"lfr>t<"F"ip>'),
              k.renderer)
              ? g.isPlainObject(k.renderer) && !k.renderer.header && (k.renderer.header = "jqueryui")
              : (k.renderer = "jqueryui")
          ...
          null !== h.iDeferLoading &&
            ((k.bDeferLoading = !0),
            (i = g.isArray(h.iDeferLoading)),
            (k._iRecordsDisplay = i ? h.iDeferLoading[0] : h.iDeferLoading),
            (k._iRecordsTotal = i ? h.iDeferLoading[1] : h.iDeferLoading));
          "" !== h.oLanguage.sUrl
            ? ((k.oLanguage.sUrl = h.oLanguage.sUrl),
              g.getJSON(k.oLanguage.sUrl, null, function(a) {
                M(a);
                G(m.oLanguage, a);
          ...
          0 === j.length || 0 === j.children().length
            ? g(this).addClass(n.sNoFooter)
            : 0 < j.length && ((k.nTFoot = j[0]), $(k.aoFooter, k.nTFoot));
      ...
      Ya = function(a, b) {
        ...
        if ("current" == e) {
          ...
          for (d = a.aoData.length; c < d; c++)
            "none" == i
              ? f.push(c)
              : ((e = g.inArray(c, h)), ((-1 === e && "removed" == i) || (1 === e && "applied" == i)) && f.push(c));
        }
        return f;
      };
    r("rows()", function(a, b) {
    ...
    r("rows.add()", function(a) {
      var b = this.iterator("table", function(b) {
          ...
          f = 0;
          for (h = a.length; f < h; f++)
            (c = a[f]), c.nodeName && "TR" === c.nodeName.toUpperCase() ? g.push(ha(b, c)[0]) : g.push(H(b, c));
          return g;
        }),
        c = this.rows(-1);
      c.pop();
          ...
          if (a === l) d = d.bVisible;
            ...
            if (d.bVisible !== a) {
              if (a) {
                ...
                g(B(b.aoData, "anCells", c)).detach(), (d.bVisible = !1), I(b, b.aoHeader), I(b, b.aoFooter), ta(b);
              d.bVisible = a;
              I(b, b.aoHeader);
              I(b, b.aoFooter);
              U(b);
    ...
    r("destroy()", function(a) {
      ...
      return this.iterator("table", function(b) {
        ...
        b.bJUI &&
          (g("th span." + d.sSortIcon + ", td span." + d.sSortIcon, h).detach(),
      ...
      header: {
        _: function(a, b, c, d) {
          g(a.nTable).on("order.dt.DT", function(a, f, g, i) {
            ...
            b.removeClass(c.sSortingClass + " " + d.sSortAsc + " " + d.sSortDesc).addClass(
              i[a] == "asc" ? d.sSortAsc : i[a] == "desc" ? d.sSortDesc : c.sSortingClass
            );
          });
        },
        jqueryui: function(a, b, c, d) {
          ...
          g("<div/>")
            ...
            .append(b.contents())
            .append(g("<span/>").addClass(d.sSortIcon + " " + c.sSortingClassJUI))
            .appendTo(b);
          g(a.nTable).on("order.dt.DT", function(a, g, i, j) {
            b.removeClass(d.sSortAsc + " " + d.sSortDesc).addClass(
              j[e] == "asc" ? d.sSortAsc : j[e] == "desc" ? d.sSortDesc : c.sSortingClass
            );
            b.find("span." + d.sSortIcon)
              ...
              .addClass(j[e] == "asc" ? d.sSortJUIAsc : j[e] == "desc" ? d.sSortJUIDesc : c.sSortingClassJUI);
          });
        }
      }
    });
