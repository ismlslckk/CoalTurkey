...
!(function(a, b) {
  ...
  function a(a, b) {
    ...
    if ((r(c) && ((b.dynamicTypingFunction = c), (c = {})), (b.dynamicTyping = c), b.worker && z.WORKERS_SUPPORTED)) {
      var h = k();
      return (
        (h.userStep = b.step),
        (h.userChunk = b.chunk),
        ...
        (b.error = r(b.error)),
        delete b.worker,
        void h.postMessage({ input: a, config: b, workerId: h.id })
      );
    }
    var i = null;
    return (
      "string" == typeof a
        ? (i = b.download ? new d(b) : new f(b))
        : a.readable === !0 && r(a.read) && r(a.on)
        ? (i = new g(b))
        : ((t.File && a instanceof File) || a instanceof Object) && (i = new e(b)),
      i.stream(a)
    );
  }
  function b(a, b) {
    function c() {
      "object" == typeof b &&
        ("string" == typeof b.delimiter &&
          1 === b.delimiter.length &&
          z.BAD_DELIMITERS.indexOf(b.delimiter) === -1 &&
          (j = b.delimiter),
    ...
    function f(a, b) {
      ...
      var c =
        ("boolean" == typeof h && h) ||
        (h instanceof Array && h[b]) ||
        g(a, z.BAD_DELIMITERS) ||
        a.indexOf(j) > -1 ||
        " " === a.charAt(0) ||
        " " === a.charAt(a.length - 1);
      return c ? l + a + l : a;
    ...
    (this._handle = null),
      ...
      (this.parseChunk = function(a) {
        ...
        if (!this._handle.paused() && !this._handle.aborted()) {
          ...
          if (v) t.postMessage({ results: d, workerId: z.WORKER_ID, finished: f });
          ...
          return (
            this._config.step ||
              this._config.chunk ||
              ((this._completeResults.data = this._completeResults.data.concat(d.data)),
      ...
      (this._sendError = function(a) {
        r(this._config.error)
          ...
          : v && this._config.error && t.postMessage({ workerId: z.WORKER_ID, error: a, finished: !1 });
      });
  }
  function d(a) {
    function b(a) {
    ...
    u
      ...
      (this._readChunk = function() {
        ...
        if (
          ...
          u || ((d.onload = q(this._chunkLoaded, this)), (d.onerror = q(this._chunkError, this))),
  ...
  function e(a) {
    ...
    var b,
      d,
      e = "undefined" != typeof FileReader;
    (this.stream = function(a) {
      (this._input = a),
        (d = a.slice || a.webkitSlice || a.mozSlice),
        e
          ? ((b = new FileReader()), (b.onload = q(this._chunkLoaded, this)), (b.onerror = q(this._chunkError, this)))
      ...
      (this._chunkError = function() {
        this._sendError(b.error.message);
      });
  }
  function f(a) {
    (a = a || {}), c.call(this, a);
  ...
  function h(a) {
      ...
      if (
        (x &&
          ...
          (l(
            ...
            "Unable to auto-detect delimiting character; defaulted to '" + z.DefaultDelimiter + "'"
          ),
          (o = !1)),
        a.skipEmptyLines)
      )
        for (var b = 0; b < x.data.length; b++) 1 === x.data[b].length && "" === x.data[b][0] && x.data.splice(b--, 1);
      return c() && d(), g();
    }
    function c() {
    ...
    function d() {
      if (x) {
        for (var a = 0; c() && a < x.data.length; a++) for (var b = 0; b < x.data[a].length; b++) w.push(x.data[a][b]);
        x.data.splice(0, 1);
      }
    }
    function e(b) {
      return (
        a.dynamicTypingFunction && void 0 === a.dynamicTyping[b] && (a.dynamicTyping[b] = a.dynamicTypingFunction(b)),
    ...
    function g() {
      if (!x || (!a.header && !a.dynamicTyping)) return x;
      for (var b = 0; b < x.data.length; b++) {
        for (var c = a.header ? {} : [], d = 0; d < x.data[b].length; d++) {
          ...
          a.header && (e = d >= w.length ? "__parsed_extra" : w[d]),
            (g = f(e, g)),
            "__parsed_extra" === e ? ((c[e] = c[e] || []), c[e].push(g)) : (c[e] = g);
        }
        (x.data[b] = c),
          a.header &&
            (d > w.length
              ? l(
                  "FieldMismatch",
                  "TooManyFields",
                  "Too many fields: expected " + w.length + " fields but parsed " + d,
                  b
                )
              : d < w.length &&
                l(
                  "FieldMismatch",
                  "TooFewFields",
                  "Too few fields: expected " + w.length + " fields but parsed " + d,
                  b
                ));
      }
    ...
    function h(b, c, d) {
      for (var e, f, g, h = [",", "\t", "|", ";", z.RECORD_SEP, z.UNIT_SEP], j = 0; j < h.length; j++) {
        var k = h[j],
          ...
          n = 0;
        g = void 0;
        for (var o = new i({ delimiter: k, newline: c, preview: 10 }).parse(b), p = 0; p < o.data.length; p++)
          if (d && 1 === o.data[p].length && 0 === o.data[p][0].length) n++;
          else {
            var q = o.data[p].length;
            (m += q), "undefined" != typeof g ? q > 1 && ((l += Math.abs(q - g)), (g = q)) : (g = q);
          }
        o.data.length > 0 && (m /= o.data.length - n),
          ("undefined" == typeof f || l < f) && m > 1.99 && ((f = l), (e = k));
      }
    ...
    if (r(a.step)) {
      ...
      a.step = function(d) {
        if (((x = d), c())) b();
          ...
          if ((b(), 0 === x.data.length)) return;
          (t += d.data.length), a.preview && t > a.preview ? n.abort() : y(x, s);
        }
      };
    }
    (this.parse = function(c, d, e) {
      if ((a.newline || (a.newline = j(c)), (o = !1), a.delimiter))
        r(a.delimiter) && ((a.delimiter = a.delimiter(c)), (x.meta.delimiter = a.delimiter));
      else {
        var f = h(c, a.newline, a.skipEmptyLines);
        f.successful ? (a.delimiter = f.bestDelimiter) : ((o = !0), (a.delimiter = z.DefaultDelimiter)),
          (x.meta.delimiter = a.delimiter);
      }
      var g = p(a);
      return (
        a.preview && a.header && g.preview++,
        (m = c),
        (n = new i(g)),
        (x = n.parse(m, d, e)),
        b(),
        u ? { meta: { paused: !0 } } : x || { meta: { paused: !1 } }
      );
    }),
  ...
  function i(a) {
    ...
    var b = a.delimiter,
      ...
      f = a.preview,
      g = a.fastMode;
    if (void 0 === a.quoteChar) var h = '"';
    else var h = a.quoteChar;
    if ((("string" != typeof b || z.BAD_DELIMITERS.indexOf(b) > -1) && (b = ","), d === b))
    ...
    (this.parse = function(a, k, l) {
      ...
      function p(a) {
        return {
          data: x,
          errors: y,
          meta: { delimiter: b, linebreak: c, aborted: j, truncated: !!a, cursor: A + (k || 0) }
        };
      }
      function q() {
        e(p()), (x = []), (y = []);
      ...
      if (g || (g !== !1 && a.indexOf(h) === -1)) {
        for (var B = a.split(c), C = 0; C < B.length; C++) {
          var z = B[C];
          if (((i += z.length), C !== B.length - 1)) i += c.length;
          else if (l) return p();
          if (!d || z.substr(0, v) !== d) {
            if (w) {
              if (((x = []), m(z.split(b)), q(), j)) return p();
            } else m(z.split(b));
            if (f && C >= f) return (x = x.slice(0, f)), p(!0);
          }
        }
        return p();
      }
      for (var D = a.indexOf(b, i), E = a.indexOf(c, i), F = new RegExp(h + h, "g"); ; )
        if (a[i] !== h)
          if (d && 0 === z.length && a.substr(i, v) === d) {
            if (E === -1) return p();
            (i = E + u), (E = a.indexOf(c, i)), (D = a.indexOf(b, i));
          } else if (D !== -1 && (D < E || E === -1)) z.push(a.substring(i, D)), (i = D + t), (D = a.indexOf(b, i));
          else {
            if (E === -1) break;
            if ((z.push(a.substring(i, E)), o(E + u), w && (q(), j))) return p();
            if (f && x.length >= f) return p(!0);
          }
        else {
          var G = i;
          for (i++; ; ) {
            ...
            if (a[G + 1] !== h) {
              if (a[G + 1] === b) {
                z.push(a.substring(i, G).replace(F, h)), (i = G + 1 + t), (D = a.indexOf(b, i)), (E = a.indexOf(c, i));
                break;
              }
              if (a.substr(G + 1, u) === c) {
                if ((z.push(a.substring(i, G).replace(F, h)), o(G + 1 + u), (D = a.indexOf(b, i)), w && (q(), j)))
                  return p();
                if (f && x.length >= f) return p(!0);
                break;
              }
  ...
  function l(a) {
    ...
    if (b.error) c.userError(b.error, b.file);
      ...
      var e = function() {
        ...
        f = { abort: e, pause: n, resume: n };
      if (r(c.userStep)) {
        for (
          var g = 0;
          g < b.results.data.length &&
          (c.userStep({ data: [b.results.data[g]], errors: b.results.errors, meta: b.results.meta }, f), !d);
          g++
        );
        delete b.results;
  ...
  function o(a) {
    var b = a.data;
    if (("undefined" == typeof z.WORKER_ID && b && (z.WORKER_ID = b.workerId), "string" == typeof b.input))
      t.postMessage({ workerId: z.WORKER_ID, results: z.parse(b.input, b.config), finished: !0 });
