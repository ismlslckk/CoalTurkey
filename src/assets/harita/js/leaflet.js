/* @preserve
 * Leaflet 1.5.0+Detached: 6d88eaf28bc5e43ef9ecd413c6aff938524f2a1e.6d88eaf, a JS library for interactive maps. http://leafletjs.com
...
!(function(t, i) {
  ...
  (B.prototype = {
    ...
    (N.prototype = {
      ...
      equals: function(t, i) {
        return (
          !!t &&
          ((t = D(t)), this._southWest.equals(t.getSouthWest(), i) && this._northEast.equals(t.getNorthEast(), i))
        );
      },
      isValid: function() {
    ...
    F = {
      ...
      infinite: !(j.prototype = {
        equals: function(t, i) {
          return (
            !!t &&
            ((t = W(t)), Math.max(Math.abs(this.lat - t.lat), Math.abs(this.lng - t.lng)) <= (void 0 === i ? 1e-9 : i))
          );
        },
        toString: function(t) {
  ...
  function xi(t, i, e) {
    var n = i || new B(0, 0);
    t.style[ni] =
      (ft ? "translate(" + n.x + "px," + n.y + "px)" : "translate3d(" + n.x + "px," + n.y + "px,0)") +
      (e ? " scale(" + e + ")" : "");
  }
  function wi(t, i) {
  ...
  var te = Qi.extend({
      ...
      expand: function() {
        ...
        return (
          t < this._section.clientHeight
            ? (pi(this._section, "leaflet-control-layers-scrollbar"), (this._section.style.height = t + "px"))
      ...
      _initLayout: function() {
        ...
        e &&
          ...
          st || Ei(i, { mouseenter: this.expand, mouseleave: this.collapse }, this));
      ...
      _update: function() {
        ...
        for (e = 0; e < this._layers.length; e++)
          (n = this._layers[e]),
            ...
            (o += n.overlay ? 0 : 1);
        return (
          this.options.hideSingleBase && ((t = t && 1 < o), (this._baseLayersList.style.display = t ? "" : "none")),
  ...
  var ee = Qi.extend({
    ...
    ne = Qi.extend({
      ...
      addAttribution: function(t) {
        return (
          t && (this._attributions[t] || (this._attributions[t] = 0), this._attributions[t]++, this._update()), this
        );
      },
  ...
  var se,
    ...
    le = k.extend({
        ...
        if (
          ...
          !di(this._element, "leaflet-zoom-anim") &&
            !(
              ...
              ((le._dragging = this)._preventOutline && zi(this._element), bi(), $t(), this._moving)
            ))
        ) {
          this.fire("down");
      ...
      finishDrag: function() {
        ...
        this._lastTarget && (mi(this._lastTarget, "leaflet-drag-target"), (this._lastTarget = null)),
        ue))
        ...
        Ti(),
          ...
          this._moved &&
            this._moving &&
            (C(this._animRequest), this.fire("dragend", { distance: this._newPos.distanceTo(this._startPos) })),
          (this._moving = !1),
          (le._dragging = !1);
      }
    });
  ...
  function me(t, i) {
    var e = 0;
    return (
      t.x < i.min.x ? (e |= 1) : t.x > i.max.x && (e |= 2), t.y < i.min.y ? (e |= 4) : t.y > i.max.y && (e |= 8), e
    );
  }
  function fe(t, i, e, n) {
    var o,
    ...
    for (r = 0; r < 4; r++) {
      for (l = _[r], n = [], o = 0, s = (u = t.length) - 1; o < u; s = o++)
        (a = t[o]),
          (h = t[s]),
          a._code & l
            ? h._code & l || (((c = pe(h, a, l, i, e))._code = me(c, i)), n.push(c))
            : (h._code & l && (((c = pe(h, a, l, i, e))._code = me(c, i)), n.push(c)), n.push(a));
      t = n;
    }
    return t;
  }
  var we,
    Pe = Object.freeze({ clipPolygon: xe }),
    Le = {
      project: function(t) {
    ...
    Te = Object.freeze({ LonLat: Le, Mercator: be, SphericalMercator: q }),
    ze = h({}, U, {
      code: "EPSG:3395",
      projection: be,
      transformation: ((we = 0.5 / (Math.PI * be.R)), K(we, 0.5, -we, 0.5))
    }),
    Me = h({}, U, { code: "EPSG:4326", projection: Le, transformation: K(1 / 180, 1, -1 / 180, 0.5) }),
    Ce = h({}, F, {
      projection: Le,
  ...
  Ji.include({
    addLayer: function(t) {
      ...
      return (
        this._layers[i] ||
          (((this._layers[i] = t)._mapToAdd = this), t.beforeAdd && t.beforeAdd(this), this.whenReady(t._layerAdd, t)),
        this
      );
    },
    removeLayer: function(t) {
    ...
    Ie = Se.extend({
      ...
      _initInteraction: function() {
        if (
          ...
          (pi(this._icon, "leaflet-interactive"), this.addInteractiveTarget(this._icon), Ae)
        ) {
  ...
  var en = Se.extend({
      ...
      onRemove: function(t) {
        t._fadeAnimated
          ? (vi(this._container, 0), (this._removeTimeout = setTimeout(a(ui, void 0, this._container), 200)))
          : ui(this._container);
      },
      getLatLng: function() {
        return this._latlng;
  ...
  Ji.mergeOptions({ closePopupOnClick: !0 }),
    ...
    Se.include({
      bindPopup: function(t, i) {
        return (
          t instanceof nn
            ...
            : ((this._popup && !i) || (this._popup = new nn(i, this)), this._popup.setContent(t)),
      ...
      openPopup: function(t, i) {
        return (
          this._popup && this._map && ((i = this._popup._prepareOpen(this, t, i)), this._map.openPopup(this._popup, i)),
          this
        );
      },
      closePopup: function() {
      ...
      bindTooltip: function(t, i) {
        return (
          t instanceof on
            ...
            : ((this._tooltip && !i) || (this._tooltip = new on(i, this)), this._tooltip.setContent(t)),
        ...
        return (
          this._tooltip &&
            ...
            this._tooltip.options.interactive &&
              ...
              (pi(this._tooltip._container, "leaflet-clickable"), this.addInteractiveTarget(this._tooltip._container))),
          this
        );
      },
  ...
  var sn = ke.extend({
    ...
    createIcon: function(t) {
      var i = t && "DIV" === t.tagName ? t : document.createElement("div"),
        e = this.options;
      if (
        (e.html instanceof Element ? (li(i), i.appendChild(e.html)) : (i.innerHTML = !1 !== e.html ? e.html : ""),
        e.bgPos)
      ) {
        var n = I(e.bgPos);
  ...
  var rn = Se.extend({
    ...
    _initContainer: function() {
      this._container ||
        ((this._container = hi("div", "leaflet-layer " + (this.options.className || ""))),
        this._updateZIndex(),
    ...
    _tileReady: function(t, i, e) {
      ...
      (e = this._tiles[n]) &&
        ...
        this._map._fadeAnimated
          ? (vi(e.el, 0), C(this._fadeFrame), (this._fadeFrame = M(this._updateOpacity, this)))
  ...
  var ln = Se.extend({
    ...
    cn = ln.extend({
      ...
      _requestRedraw: function(t) {
        this._map &&
          (this._extendRedrawBounds(t), (this._redrawRequest = this._redrawRequest || M(this._redraw, this)));
      },
        ...
        (o.stroked = !!n.stroke),
          ...
          n.stroke
            ? (i || (i = t._stroke = dn("stroke")),
              ...
              (i.opacity = n.opacity),
              n.dashArray
                ? (i.dashStyle = v(n.dashArray) ? n.dashArray.join(" ") : n.dashArray.replace(/( *, *)/g, " "))
                : (i.dashStyle = ""),
  ...
  var yn = oe.extend({
    ...
    _onMouseDown: function(t) {
      ...
      this._clearDeferredResetState(),
        ...
        Ei(
          document,
          { contextmenu: ji, mousemove: this._onMouseMove, mouseup: this._onMouseUp, keydown: this._onKeyDown },
          this
        );
    },
    _onMouseMove: function(t) {
  ...
  var Pn = oe.extend({
    ...
    addHooks: function() {
      ...
      t.tabIndex <= 0 && (t.tabIndex = "0"),
        Ei(t, { focus: this._onFocus, blur: this._onBlur, mousedown: this._onMouseDown }, this),
        this._map.on({ focus: this._addHooks, blur: this._removeHooks }, this);
    },
    removeHooks: function() {
      this._removeHooks(),
        Bi(this._map._container, { focus: this._onFocus, blur: this._onBlur, mousedown: this._onMouseDown }, this),
  ...
  Ji.addInitHook("addHandler", "keyboard", Pn),
    Ji.mergeOptions({ scrollWheelZoom: !0, wheelDebounceTime: 40, wheelPxPerZoomLevel: 60 });
  var Ln = oe.extend({
    addHooks: function() {
  ...
  Ji.addInitHook("addHandler", "scrollWheelZoom", Ln), Ji.mergeOptions({ tap: !0, tapTolerance: 15 });
  var bn = oe.extend({
    addHooks: function() {
