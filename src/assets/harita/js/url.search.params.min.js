...
!(function(l) {
  ...
  "forEach" in l ||
    ...
    "sort" in l ||
      (l.sort = function() {
        for (var t, n, e, r = this.entries(), i = r.next(), a = i.done, s = [], c = Object.create(null); !a; )
          (n = (e = i.value)[0]), s.push(n), n in c || (c[n] = []), c[n].push(e[1]), (a = (i = r.next()).done);
    ...
    (function(c) {
      var o = c.defineProperty,
        ...
        f = function(t, n) {
          if (!(t instanceof n))
            throw new TypeError("'searchParams' accessed on an object that does not implement interface " + n.name);
        },
        t = function(n) {
          var e,
            r,
