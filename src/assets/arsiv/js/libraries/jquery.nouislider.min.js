(function(f) {
  f.fn.noUiSlider = function(n, r) {
    function s(a, e, c) {
      ...
      2 == e.handles &&
        (c.is(":first-child")
          ? ((c = parseFloat(l[1][0].style[g]) - e.margin), (a = a > c ? c : a))
          : ((c = parseFloat(l[0][0].style[g]) + e.margin), (a = a < c ? c : a)));
    ...
    function t(a) {
      try {
        return [
          a.clientX || a.originalEvent.clientX || a.originalEvent.touches[0].clientX,
          a.clientY || a.originalEvent.clientY || a.originalEvent.touches[0].clientY
        ];
      } catch (e) {
        return ["x", "y"];
      }
    ...
    var m = {
      ...
      w = { handles: 2, serialization: { to: ["", ""], resolution: 0.01 } };
    methods = {
      create: function() {
        return this.each(function() {
          ...
          f.each(a, function(b, d) {
            h(d)
              ? (a[b] = parseFloat(d))
              : "object" == typeof d && h(d[0]) && ((d[0] = parseFloat(d[0])), h(d[1]) && (d[1] = parseFloat(d[1])));
            var c = !1;
          ...
          if (
            a.serialization.to instanceof jQuery ||
            "string" == typeof a.serialization.to ||
            !1 === a.serialization.to
          )
            a.serialization.to = [a.serialization.to];
          "vertical" == a.orientation
            ? ((b += "vertical"), (g = "top"), (l = 1))
            : ((b += "horizontal"), (g = "left"), (l = 0));
          ...
          for (b = 0; b < a.handles; b++) {
            ...
            c[b]
              .find("div")
              .on(k, function(b) {
                f("body").bind("selectstart.noUiSlider", function() {
                  return !1;
                });
          ...
          for (b = 0; b < c.length; b++)
            (k = m.is(a.range, parseFloat(c[b][0].style[g])).toFixed(q)),
              "string" == typeof a.serialization.to[b]
                ? c[b].data(
                    "input",
                    e
                      .append('<input type="hidden" name="' + a.serialization.to[b] + '">')
                      .find("input:last")
                      .val(k)
                      .change(function(a) {
                        a.stopPropagation();
          ...
          f(this).data("setup", { settings: a, handles: c, pos: g, res: q });
        });
      },
      val: function(a) {
        if ("undefined" !== typeof a) {
          ...
          return this.each(function() {
            for (var a = f(this).data("setup"), b = 0; b < a.handles.length; b++)
              if (null != e[b]) {
                var c = s(m.to(a.settings.range, e[b]), f(this), a.handles[b]);
                a.handles[b]
                  .css(a.pos, c + "%")
                  .data("input")
                  .val(m.is(a.settings.range, c).toFixed(a.res));
              }
          });
        }
